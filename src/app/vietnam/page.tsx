        ...
        <div className="min-h-screen">
                            ...
                            <div className="overflow-x-auto -mx-4 px-4">
                                <div className="flex md:grid md:grid-cols-3 gap-6 min-w-min md:min-w-0">
                                    {packages
                                        ...
                                        .map((vietnamPkg) => (
                                            <PackageCard key={vietnamPkg.id} package={vietnamPkg} />
                                        ))}
                                </div>
                            </div>
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {vietnamHighlights.map((highlight, index) => (
                                <motion.div
                                    key={highlight.title}
                                    initial={{ opacity: 0, y: 20 }}
                                    whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="max-w-4xl mx-auto mt-16 prose prose-lg">
                ...
                <div className="text-gray-600 space-y-4">
                    <p>
                        The beaches in vietnam are something to look forward to, as the golden shaded beaches and water are fairly land for the surfers. You are basically spoilt for choices in the activities available.
                    </p>
                    <p>
                        Moving on to the land, the vietnam Tour Package consist of a trek in Mount Batur, visit the Tegallalang Rice Terraces and being amidst the animals in the vietnam safari and marine parks, mountain biking in the landscapes and the paddy fields.
                    </p>
                    <p>
