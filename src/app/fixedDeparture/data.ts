...
export const fixedDeparturesData: Record<string, FixedDeparture> = {
    europe: {
        ...
        groupDetails: {
            ...
            arrivalDate: "16th October 2025 Raipur Departure",
    ...
    vietnam2: {
        ...
        groupDetails: {
            ...
            arrivalDate: "Available Dates:  15 October (Last Slot)",
    ...
    euroQuest: {
        ...
        groupDetails: {
            ...
            arrivalDate: "Departure 1: October 7, 2025 – October 21, 2025\nDeparture 2: October 21, 2025 – October 4, 2025",
        ...
        hotelDetails: [
            {
                ...
                roomType: "Standard Room (Check In: 17 October / 22 October / 29 October / 26 October)"
            },
            {
                city: "Saint Petersburg",
                hotel: "Theatre Square Hotel or Sadovaya (ex. Holiday Inn)",
                roomType: "Standard Room (Check-in dates: 8 October / 29 October / 12 October)"
            },
            {
                city: "Moscow",
...
`
    ...
    newZealandFixedDeparture: {
        ...
        inclusions: [
            ...
            "The menu matrix October change to offer more variety. All meals will bе 100% pure vegetarian",
...
`
    ...
    bakuFixedDeparture: {
        ...
        groupDetails: {
            pax: "Group Tour Fixed Departure",
            rooms: "Double/Single Sharing Available",
            arrivalDate: "10th October 2025",
            duration: "7D6N Azerbaijan",
            costBasis: "Double sharing basis"
        },
        tourSummary: [
            "Day 1: (10th October): Arrival in Baku",
            "Day 2: (11th October): Gabala City Tour",
            "Day 3: (12th October): Baku City Tour",
            "Day 4: (13th October): Maiden Tower, Shirvanshah Palace, Icherisheher",
            "Day 5: (14th October): Shahdag",
            "Day 6: (15th October): Zip Lining, Hiking, Spa",
            "Day 7: (16th October): Transfer to Baku Airport",
        ...
        inclusions: [
            ...
            "The menu matrix October change to offer more variety. All meals will be 100% pure vegetarian only",
...
export const destinationsWithoutFlight: Record<string, DestinationWithoutFlight> = {
    ...
    malaysia: {
        ...
        groupDetails: {
            pax: "Group Tour",
            rooms: "Twin Sharing Basis",
            arrivalDate: "Multiple dates between October 2025",
    ...
    bhutan: {
        ...
        groupDetails: {
            pax: "Group Tour",
            rooms: "Twin Sharing Basis",
            arrivalDate: "Multiple dates: 23,30 October, 18,25,30 October",
...
It is one of the most famous of Bhutan&apos;s monasteries, perched on the side of a cliff 900m above the Paro valley floor. It is said that Guru Rinpoche arrived here on the back of a tigress and meditated at this monastery and hence it is called Tiger&apos;s Nest. This site has been recognised as a most sacred place and visited by Shabdrung Ngawang Namgyal in 1646 and now visited by all Bhutanese at least once in their lifetime. On 19 October, 1998, a fire severely damaged the main structure of building but now this Bhutanese jewel has been restored to its original splendour.
