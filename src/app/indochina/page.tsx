...
import { indochinaPackages, indochinaPackage } from './data';
...
export default function IndochinaPackages() {
    const [currentPage, setCurrentPage] = useState(0);
    const [openFaq, setOpenFaq] = useState<number | null>(null);
    const packages = Object.values(indochinaPackages);
    ...
    const faqs = [
        {
            ...
            answer: "The best time to visit Vietnam is from May to October when the weather is dry and less humid. December is peak season with higher prices, while January sees more rainfall."
        },
        {
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="relative h-[60vh] md:h-[100vh] w-full overflow-hidden">
                ...
                >
                    <source src="/UGCImages/vietnam/vietnami.mp4" type="video/mp4" />
                    {/* Fallback image in case video fails to load */}
                    <Image
                        src="/UGCImages/vietnam/vietnam.jpg"
                        alt="vietnam Paradise"
                        fill
                            ...
                            <div className="overflow-x-auto -mx-4 px-4">
                                <div className="flex md:grid md:grid-cols-3 gap-6 min-w-min md:min-w-0">
                                    {packages
                                        ...
                                        .map((indochinaPkg) => (
                                            <PackageCard key={indochinaPkg.id} package={indochinaPkg} />
                                        ))}
                                </div>
                            </div>
            ...
            <div className="max-w-4xl mx-auto mt-16 prose prose-lg">
                ...
                <div className="text-gray-600 space-y-4">
                    <p>
                        The beaches in Indochina are something to look forward to, as the golden shaded beaches and water are fairly land for the surfers. You are basically spoilt for choices in the activities available.
                    </p>
                    <p>
                        Moving on to the land, the Indochina Tour Package consist of a trek in Mount Batur, visit the Tegallalang Rice Terraces and being amidst the animals in the Indochina safari and marine parks, mountain biking in the landscapes and the paddy fields.
                    </p>
                    <p>
