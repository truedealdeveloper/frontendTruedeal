...
export const baliPackages: Record<string, BaliPackage> = {
    baliFixedDeparture: {
        ...
        tourSummary: [
            ...
            "Day 6: Bali Swing – Ubud Palace – Ubud Market Shopping Tour",
            "Day 7: Departure"
        ],
        inclusions: [
        ...
        itinerary: [
            ...
            {
                day: 6,
                title: "Bali Swing – Ubud Palace",
                description: "Breakfast at the villa. Proceed for Bali Swing Pioneer Package including multiple swing experiences. Lunch at an Indian restaurant, followed by visits to Ubud Palace and Ubud Market for shopping. Dinner at an Indian restaurant."
            },
            {
                day: 7,
                title: "Departure",
...
Depending on your flight timings, You will be transferred from Hotel to Bali International Airport, for your flight back to your home / Next Destination.`
    ...
    baliGiliT: {
        id: "bali-gili-t",
        packageName: "Bali Gili Trawangan Package",
        days: 9,
        nights: 8,
        amount: 48000,
