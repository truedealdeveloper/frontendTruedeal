    ...
    const faqs = [
        {
            ...
            answer: "The best time to visit Bali is from May to August when the weather is dry and less humid. December is peak season with higher prices, while January sees more rainfall."
        },
        {
