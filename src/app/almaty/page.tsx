...
import { almatyPackages, AlmatyPackage } from './data';
...
export default function AlmatyPackages() {
    const [currentPage, setCurrentPage] = useState(0);
    const [openFaq, setOpenFaq] = useState<number | null>(null);
    const packages = Object.values(almatyPackages);
    ...
    const toggleMute = () => {
        const audio = document.getElementById('almatyAudio') as HTMLAudioElement;
        const video = document.getElementById('almatyVideo') as HTMLVideoElement;
        if (audio && video) {
            if (isMuted) {
                audio.muted = false;
                video.muted = true;
    ...
    const faqs = [
        {
            ...
            answer: "Summer (June-August) is perfect for outdoor activities and sightseeing. Winter (December-February) is ideal for skiing and winter sports."
        },
        {
            question: "Do I need a visa to visit Kazakhstan?",
            answer: "Many countries have visa-free access to Kazakhstan. Check the official requirements for your nationality before traveling."
        },
        {
            question: "What activities can I do in Almaty?",
            answer: "Almaty offers hiking, skiing, ice skating at Medeu, city tours, shopping at Green Bazaar, and visits to cultural sites like Zenkov Cathedral."
        },
        {
            question: "Is Almaty safe for tourists?",
            answer: "Almaty is generally safe for tourists. Exercise normal precautions as you would in any major city."
        }
    ] as const;
        ...
        <div className="min-h-screen">
            ...
            <div className="relative h-[60vh] md:h-[100vh] w-full overflow-hidden">
                <audio
                    ...
                    className="hidden"
                >
                    <source src="/UGCImages/almaty/audio/almaty.mp3" type="audio/mp3" />
                </audio>
                ...
                <div className="absolute inset-0 flex items-center justify-center text-center">
                    <div className="max-w-4xl px-4">
                        ...
                        >
                            ...
                            >
                                Where mountains meet modernity
                            </motion.p>
                            ...
                            <div className="overflow-x-auto -mx-4 px-4">
                                <div className="flex md:grid md:grid-cols-3 gap-6 min-w-min md:min-w-0">
                                    {packages
                                        ...
                                        .map((almatyPkg) => (
                                            <PackageCard key={almatyPkg.id} package={almatyPkg} />
                                        ))}
                                </div>
                            </div>
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
                            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#017ae3] to-[#00f6ff]">
                                Experience the Beauty of Almaty
                            </span>
                        </h2>
                        
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {almatyHighlights.map((highlight, index) => (
                                <motion.div
                                    key={highlight.title}
                                    initial={{ opacity: 0, y: 20 }}
                                    whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="max-w-4xl mx-auto mt-16 prose prose-lg">
                ...
                <div className="text-gray-600 space-y-4">
                    ...
                    <p>
                        Experience the rich Kazakh culture through visits to traditional bazaars, historical museums, and architectural landmarks like the colorful Zenkov Cathedral.
                    </p>
                </div>
            </div>
