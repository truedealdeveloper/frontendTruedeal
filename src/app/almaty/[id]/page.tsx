...
import { almatyPackages } from '../data';
...
import AlmatyPackages from '../page';
// import AlmatyBanner from '@/app/components/homepage/AlmatyBanner';
...
export default function AlmatyPackagePage({ params }: PageProps) {
    const { id } = use(params);
    const almatyPkg = Object.values(almatyPackages).find(p => p.id === id);
    ...
    useEffect(() => {
        const timer = setInterval(() => {
            setCurrentImageIndex((prev) =>
                prev === (almatyPkg?.images?.length || 1) - 1 ? 0 : prev + 1
            );
        }, 5000);

        return () => clearInterval(timer);
    }, [almatyPkg?.images?.length]);
    ...
    return (
        <div className={`min-h-screen bg-gray-50 ${poppins.className} relative`}>
            ...
            <div className="relative h-[70vh] md:h-[80vh] overflow-hidden">
                <AnimatePresence mode='wait'>
                    <motion.img
                        ...
                        src={almatyPkg?.images?.[currentImageIndex] || '/default-image.jpg'}
                        alt={almatyPkg.packageName}
                            ...
                            >
                                ...
                                <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-8 text-base md:text-lg">
                                    <span className="flex items-center gap-3">
                                        ...
                                        <span>{almatyPkg.dateStart} - {almatyPkg.dateEnd}</span>
                                    </span>
                                    <span className="flex items-center gap-3">
                                        <FaClock className="text-[#00f6ff]" />
                                        <span>{almatyPkg.days}D/{almatyPkg.nights}N</span>
                                    </span>
                                </div>
                            </motion.div>
            ...
            <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
                        <div className="lg:col-span-2 space-y-4">
                            <div className="bg-white rounded-lg shadow-sm p-6">
                                ...
                                <p className="text-gray-600 mb-6">{almatyPkg.description}</p>

                                {/* Tour Summary Box */}
                                <div className="bg-blue-50 rounded-lg p-4 mb-6">
                                    <h3 className="text-lg font-semibold mb-4">Tour Overview</h3>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        {almatyPkg.tourSummary?.map((day, index) => (
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                    {almatyPkg.groupDetails && (
                                        <>
                                            <div className="bg-gray-50 p-4 rounded-lg">
                                                <h4 className="font-semibold mb-2">Duration</h4>
                                                <p>{almatyPkg.groupDetails.duration}</p>
                                            </div>
                                            <div className="bg-gray-50 p-4 rounded-lg">
                                                <h4 className="font-semibold mb-2">Accommodation</h4>
                                                <p>{almatyPkg.groupDetails.rooms}</p>
                                            </div>
                                            <div className="bg-gray-50 p-4 rounded-lg">
                                                <h4 className="font-semibold mb-2">Group Size</h4>
                                                <p>{almatyPkg.groupDetails.pax}</p>
                                            </div>
                                            <div className="bg-gray-50 p-4 rounded-lg">
                                                <h4 className="font-semibold mb-2">Cost Basis</h4>
                                                <p>{almatyPkg.groupDetails.costBasis}</p>
                                            </div>
                                        </>
                                    )}
                                </div>

                                {almatyPkg.departureDates && (
                                    <div className="mt-6">
                                        <h3 className="text-lg font-semibold mb-4">Departure Dates</h3>
                                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                                            {almatyPkg.departureDates.map((departure, index) => (
                        ...
                        <div className="space-y-4">
                            <div className="bg-white rounded-lg shadow-sm p-6 sticky top-20">
                                <div className="text-center mb-4">
                                    {almatyPkg.amount && (
                                        <>
                                            <p className="text-gray-500 line-through">₹{(almatyPkg.amount * 1.2).toLocaleString('en-IN')}/-</p>
                                            <p className="text-3xl font-bold text-[#017ae3]">₹{almatyPkg.amount.toLocaleString('en-IN')}/-</p>
                                        </>
                                    )}
                ...
                <div ref={itineraryRef} className="scroll-mt-16 mt-8">
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div className="space-y-6">
                            {almatyPkg.itinerary.map((day, index) => (
                ...
                <div ref={inclusionsRef} className="scroll-mt-16 mt-8">
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {almatyPkg.inclusions?.map((item, index) => (
                ...
                <div ref={exclusionsRef} className="scroll-mt-16 mt-8">
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {almatyPkg.exclusions?.map((item, index) => (
                                <div key={index} className="flex items-start gap-2 bg-gray-50 p-4 rounded-lg">
                        ...
                        {almatyPkg.additionalInfo && (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        <ul className="list-disc list-inside space-y-2">
                                            {almatyPkg.additionalInfo.highlights.map((highlight, index) => (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        <ul className="list-disc list-inside space-y-2">
                                            {almatyPkg.additionalInfo.cuisine.map((item, index) => (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-4">
                                        {almatyPkg.hotelDetails.map((hotel, index) => (
                                            <div key={index} className="bg-gray-50 p-4 rounded-lg">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        <p className="text-gray-700 mb-2"><strong>Requirement:</strong> {almatyPkg.additionalInfo.visaInfo.requirement}</p>
                                        <p className="text-gray-700 mb-2"><strong>Duration:</strong> {almatyPkg.additionalInfo.visaInfo.duration}</p>
                                        <p className="text-gray-700 mb-2"><strong>Cost:</strong> {almatyPkg.additionalInfo.visaInfo.cost}</p>
                                        <h4 className="font-semibold mt-4 mb-2">Required Documents:</h4>
                                        <ul className="list-disc list-inside space-y-1">
                                            {almatyPkg.additionalInfo.visaInfo.documents.map((doc, index) => (
                ...
                <div className="mt-8">
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {almatyPkg.sightseeingSpots?.map((spot, index) => (
                ...
                <div className="mt-8">
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {almatyPkg.localFood?.map((food, index) => (
                ...
                <div className="mt-8">
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        <h2 className="text-2xl font-bold mb-6 text-[#017ae3] border-b pb-4">Kazakh Culture & Traditions</h2>
                        <div 
                            ref={cultureScrollRef}
                            className="overflow-x-hidden relative"
                        >
                            <div className="flex gap-6 animate-scroll">
                                {[...almatyPkg.culture, ...almatyPkg.culture]?.map((item, index) => (
                                    <div 
                                        key={index} 
            ...
            <BookingFormModal
                ...
                destinationName={almatyPkg.packageName}
                price={almatyPkg.amount}
                dates={`${almatyPkg.dateStart} - ${almatyPkg.dateEnd}`}
            />
