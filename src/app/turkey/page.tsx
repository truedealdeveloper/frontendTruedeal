    ...
    const faqs = [
        {
            ...
            answer: "The best time to visit Turkey is during spring (April to May) and autumn (October to November) when the weather is pleasant and crowds are smaller. Summer (October to October) is peak tourist season but can be very hot."
        },
        {
