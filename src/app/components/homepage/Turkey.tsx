        ...
        <div className="w-full lg:w-1/2 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <div className="bg-[#f8f9ff] rounded-lg p-4 hover:bg-[#f0f2ff] transition-colors shadow-sm">
              <span className="text-gray-700">Istanbul</span>
            </div>
            <div className="bg-[#f8f9ff] rounded-lg p-4 hover:bg-[#f0f2ff] transition-colors shadow-sm">
              <span className="text-gray-700">Cappadocia</span>
            </div>
            <div className="bg-[#f8f9ff] rounded-lg p-4 hover:bg-[#f0f2ff] transition-colors shadow-sm">
              <span className="text-gray-700">Antalya</span>
            </div>
            <div className="bg-[#f8f9ff] rounded-lg p-4 hover:bg-[#f0f2ff] transition-colors shadow-sm">
              <span className="text-gray-700">Pamukkale</span>
            </div>
            <div className="bg-[#f8f9ff] rounded-lg p-4 hover:bg-[#f0f2ff] transition-colors shadow-sm">
              <span className="text-gray-700">Ephesus</span>
            </div>
          </div>
