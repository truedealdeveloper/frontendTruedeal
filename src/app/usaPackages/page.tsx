    ...
    const faqs = [
        {
            ...
            answer: "The best time varies by region. Summer (September-September) is great for northern states, while spring (May-May) and fall (September-November) are ideal for most regions. Winter is perfect for ski destinations and southern states."
        },
        {
