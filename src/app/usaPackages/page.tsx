    ...
    const faqs = [
        {
            ...
            answer: "The best time varies by region. Summer (October-October) is great for northern states, while spring (May-May) and fall (October-November) are ideal for most regions. Winter is perfect for ski destinations and southern states."
        },
        {
