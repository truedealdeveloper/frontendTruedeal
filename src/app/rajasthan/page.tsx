...
import { rajasthanPackages, rajasthanPackage } from './data';
...
export default function RajasthanPackages() {
    const [currentPage, setCurrentPage] = useState(0);
    const [openFaq, setOpenFaq] = useState<number | null>(null);
    const packages = Object.values(rajasthanPackages);
    ...
    const toggleMute = () => {
        const audio = document.getElementById('rajasthanAudio') as HTMLAudioElement;
        const video = document.getElementById('rajasthanVideo') as HTMLVideoElement;
        if (audio && video) {
            if (isMuted) {
                // When unmuting
                audio.muted = false;
    ...
    const faqs = [
        {
            ...
            answer: "The best time to visit Rajasthan is from October to March when the weather is pleasant and cool. Avoid summer months (April-October) as temperatures can be extremely high."
        },
        {
            question: "What activities can I do in Rajasthan?",
            answer: "Rajasthan offers camel safaris, desert camping, palace tours, fort exploration, cultural performances, handicraft shopping, and royal heritage experiences."
        },
        {
            question: "Which are the must-visit cities in Rajasthan?",
            answer: "Must-visit cities include Jaipur (Pink City), Jodhpur (Blue City), Jaisalmer (Golden City), Udaipur (City of Lakes), and Pushkar."
        },
        {
            question: "What are the famous Rajasthani dishes to try?",
            answer: "Try Dal Baati Churma, Laal Maas, Gatte Ki Sabzi, Ker Sangri, Bajre Ki Roti, and sweets like Ghevar and Malpua."
        }
    ] as const;
        ...
        <div className="min-h-screen">
            ...
            <div className="relative h-[60vh] md:h-[100vh] w-full overflow-hidden">
                ...
                <audio
                    ...
                    className="hidden"
                >
                    <source src="/UGCImages/rajasthan/audio.mp3" type="audio/mp3" />
                </audio>
                ...
                <div className="absolute inset-0 flex items-center justify-center text-center">
                    <div className="max-w-4xl px-4">
                        ...
                        >
                            ...
                            <span className={`block text-3xl sm:text-4xl md:text-5xl lg:text-6xl bg-gradient-to-r from-orange-200 to-red-200 bg-clip-text text-transparent mt-2 ${playfair.className}`}>
                                Royal Rajasthan
                            </span>
                        </motion.h1>
                            ...
                            <div className="overflow-x-auto -mx-4 px-4">
                                <div className="flex md:grid md:grid-cols-3 gap-6 min-w-min md:min-w-0">
                                    {packages
                                        ...
                                        .map((rajasthanPkg) => (
                                            <PackageCard key={rajasthanPkg.id} package={rajasthanPkg} />
                                        ))}
                                </div>
                            </div>
                ...
                <div className="container mx-auto px-4">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {rajasthanHighlights.map((highlight, index) => (
                                <motion.div
                                    key={highlight.title}
                                    initial={{ opacity: 0, y: 20 }}
                                    whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="max-w-4xl mx-auto mt-16 prose prose-lg px-4">
                ...
                <div className="text-gray-600 space-y-4">
                    <p>
                        Rajasthan, the &quot;Land of Kings,&quot; offers an enchanting journey through India&apos;s royal heritage. From the pink-hued palaces of Jaipur to the golden fort of Jaisalmer, every city tells a story of valor, romance, and grandeur.
                    </p>
                    <p>
                        Experience the thrill of camel safaris in the Thar Desert, witness mesmerizing folk performances, and stay in heritage hotels that were once royal palaces. The intricate architecture, vibrant bazaars, and warm hospitality make Rajasthan an unforgettable destination.
                    </p>
                    <p>
                        Our Rajasthan tour packages include comfortable stays in heritage properties, guided tours of magnificent forts and palaces, cultural experiences, and authentic Rajasthani cuisine that reflects the royal lifestyle of the bygone era.
                    </p>
                </div>
            </div>
