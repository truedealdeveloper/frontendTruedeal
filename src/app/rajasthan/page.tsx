    ...
    const faqs = [
        {
            ...
            answer: "The best time to visit Rajasthan is from October to March when the weather is pleasant and cool. Avoid summer months (April-June) as temperatures can be extremely high."
        },
        {
